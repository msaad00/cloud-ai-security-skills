...
| L1 ingest | shipping | 23 source-specific ingesters plus 4 read-only source adapters; ingest and detect are fully dual-mode where OCSF-native parity makes sense |
