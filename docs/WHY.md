...
job can call one of these 133 skills the same way it would call any other tool.
...
### C. *"My team will write all 133 skills from scratch."*
...
surface is larger: 133 skills across ingest, source, discover, detect,
