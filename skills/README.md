...
| [`ingest-sap-audit-log-ocsf`](ingestion/ingest-sap-audit-log-ocsf/) | SAP Security Audit Log exports |
...
| [`detect-sap-priv-user-access`](detection/detect-sap-priv-user-access/) | SAP privileged user or SAP_ALL/SAP_NEW access |
| [`detect-sap-mass-change`](detection/detect-sap-mass-change/) | SAP mass changes through sensitive transactions |
...
| Skill | Scope |
|---|---|
| [`iam-departures-aws`](remediation/iam-departures-aws/) | AWS IAM cleanup for departed employees (GCP and Azure Entra handled by their own `iam-departures-*` skills) |
