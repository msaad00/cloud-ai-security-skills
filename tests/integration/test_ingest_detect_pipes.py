...
INGEST_DETECT_PIPES = (
    ...
    IngestDetectPipe(
        name="databricks_cluster_init_script_abuse",
        ingest_skill="ingest-databricks-audit-ocsf",
        detect_skill="detect-databricks-cluster-init-script-abuse",
        raw_fixture="databricks_cluster_init_script_abuse_raw.jsonl",
        expected_fixture="databricks_cluster_init_script_abuse_pipe_findings.ocsf.jsonl",
        expected_ocsf_count=4,
        expected_finding_count=2,
    ),
    IngestDetectPipe(
        name="databricks_mlflow_model_exfil",
        ingest_skill="ingest-databricks-audit-ocsf",
        detect_skill="detect-databricks-mlflow-model-exfil",
        raw_fixture="databricks_mlflow_model_exfil_raw.jsonl",
        expected_fixture="databricks_mlflow_model_exfil_pipe_findings.ocsf.jsonl",
        expected_ocsf_count=4,
        expected_finding_count=2,
    ),
    IngestDetectPipe(
        name="databricks_secret_scope_read_burst",
        ingest_skill="ingest-databricks-audit-ocsf",
        detect_skill="detect-databricks-secret-scope-read-burst",
        raw_fixture="databricks_secret_scope_read_burst_raw.jsonl",
        expected_fixture="databricks_secret_scope_read_burst_pipe_findings.ocsf.jsonl",
        expected_ocsf_count=35,
        expected_finding_count=1,
    ),
    IngestDetectPipe(
        name="databricks_token_creation",
        ingest_skill="ingest-databricks-audit-ocsf",
        detect_skill="detect-databricks-token-creation",
        raw_fixture="databricks_token_creation_raw.jsonl",
        expected_fixture="databricks_token_creation_pipe_findings.ocsf.jsonl",
        expected_ocsf_count=3,
        expected_finding_count=2,
    ),
    IngestDetectPipe(
        name="databricks_unity_catalog_cross_workspace_share",
        ingest_skill="ingest-databricks-audit-ocsf",
        detect_skill="detect-databricks-unity-catalog-cross-workspace-share",
        raw_fixture="databricks_unity_catalog_cross_workspace_share_raw.jsonl",
        expected_fixture="databricks_unity_catalog_cross_workspace_share_pipe_findings.ocsf.jsonl",
        expected_ocsf_count=4,
        expected_finding_count=2,
    ),
    IngestDetectPipe(
        name="databricks_workspace_admin_grant",
        ingest_skill="ingest-databricks-audit-ocsf",
        detect_skill="detect-databricks-workspace-admin-grant",
        raw_fixture="databricks_workspace_admin_grant_raw.jsonl",
        expected_fixture="databricks_workspace_admin_grant_pipe_findings.ocsf.jsonl",
        expected_ocsf_count=4,
        expected_finding_count=2,
    ),
    IngestDetectPipe(
