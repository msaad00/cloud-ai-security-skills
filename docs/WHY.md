...
job can call one of these 134 skills the same way it would call any other tool.
...
### C. *"My team will write all 134 skills from scratch."*
...
surface is larger: 134 skills across ingest, source, discover, detect,
