...
| **MITRE ATT&CK v14** | strong and broader | 79 mapped skills across cloud, identity, Kubernetes, container, MCP, Databricks, and remediation paths. Auto-generated rollup in [`docs/FRAMEWORK_COVERAGE.md`](FRAMEWORK_COVERAGE.md); per-skill mapping in [`docs/framework-coverage.json`](framework-coverage.json) |
