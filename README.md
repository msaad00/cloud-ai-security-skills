...
<p align="center"><strong>94 production-grade security skills for cloud and AI — OCSF on the wire, MCP-ready, HITL-audited, sandboxed, runs everywhere the same bundle can.</strong></p>
...
|---|---:|---|---|
| **Ingest** | 16 | normalize raw cloud / identity / K8s / MCP / SaaS signal | OCSF 1.8 (native opt-in) |
...
**Which vendor signals normalize to OCSF today?** [`docs/INGEST_COVERAGE.md`](docs/INGEST_COVERAGE.md) — the canonical vendor × source × OCSF class matrix, 17 mappings shipped (AWS · GCP · Azure · Entra · K8s · Okta · Workspace · MCP · Slack) plus the 8 documented roadmap rows (GitHub, Workday, Salesforce, SAP, AWS Config, native ClickHouse audit, AWS web-app exfil pipeline, Workspace beyond-login).
