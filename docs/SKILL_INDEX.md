...
The same 132 skill bundles, pivoted three ways:
...
### Warehouse (Snowflake · Databricks · ClickHouse) — 17 skills
...
| Layer | Count | Index |
|---|---:|---|
| Ingest | 23 | [`skills/ingestion/`](../skills/ingestion/) (excludes the 4 warehouse sources below) |
