![Cloud AI Security Skills — 133 deterministic security skills. OCSF on the wire. MCP-ready. HITL-gated writes.](docs/images/hero-banner.svg)
...
<p align="center"><strong>133 deterministic security skills for cloud &amp; AI infrastructure.</strong> Ingest, detect, evaluate, remediate — one bundle on CLI, CI, MCP, webhook, library, and runners.</p>
...
**133 shipped skills.** Live counts: [`docs/COVERAGE_SNAPSHOT.md`](docs/COVERAGE_SNAPSHOT.md). Vendor ingest matrix: [`docs/INGEST_COVERAGE.md`](docs/INGEST_COVERAGE.md). Why not roll your own: [`docs/WHY.md`](docs/WHY.md).
...
|---|---|---|---|
| **This repo** | security skills, OCSF wire, HITL gates, allowlists, audit | 133 skill bundles + MCP wrapper | always — facts, mappings, and write authority stay here |
