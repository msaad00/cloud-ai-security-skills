...
| **Discover** | point-in-time inventory / graph / evidence / AI BOM | OCSF inventory/evidence where it fits; otherwise deterministic bridge JSON or CycloneDX-aligned BOM |
