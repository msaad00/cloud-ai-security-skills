...
- **ATT&CK depth:** 42 mapped skills in the coverage registry, with the first
  AWS IAM-user console-persistence slice now shipped via login-profile creation
...
- `ATT&CK gap: AWS IAM-user access-key and temporary-credential identity pivots`
