...
| **MITRE ATLAS + OWASP LLM/MCP (`#255`)** | **30%** | MCP prompt injection, tool drift, credential leak, system-prompt extraction, tool-output exfiltration-instruction detection, and MCP tool quarantine are shipped |
