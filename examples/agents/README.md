...
| [`continue_mcp_security_agent.py`](continue_mcp_security_agent.py) | Continue (VS Code / JetBrains) | `~/.continue/config.yaml` `mcpServers` list + harness profile; absolute-path MCP stdio |
